...
std::tuple<double, uint16_t, uint16_t, uint16_t, uint16_t> AntSolution::exploreExchange(bool objective) {
...
bool AntSolution::isFeasibleExchange(uint16_t fPos, uint16_t fClus, uint16_t sPos, uint16_t sClus) {
      uint16_t fVertex = partitions[fClus][fPos];
      uint16_t sVertex = partitions[sClus][sPos];
...
double AntSolution::evaluateExchange(bool objective, uint16_t fPos, uint16_t fClus, uint16_t sPos, uint16_t sClus) {
      uint16_t fVertex = partitions[fClus][fPos];
      uint16_t sVertex = partitions[sClus][sPos];
      if (!objective) {
